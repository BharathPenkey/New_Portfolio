        ...
        shadow-[0_10px_40px_rgba(0,0,0,0.5)]">
          ...
          opacity-30 blur-xl"></div>
                ...
                <p className="relative text-[#C2B0A3] leading-relaxed text-lg">
                    ...
                    user-friendly interfaces that deliver real-world impact. I am also highly passionate about
                    learning new technologies and continuously improving my skill set.
                </p>
